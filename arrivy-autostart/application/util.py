...
class Util:
    ...
    def delete_task_status(cls, task_id, company_id, task_status_type, force_delete=False):
        ...
        status_to_be_deleted = TaskStatusData.query(TaskStatusData.type == task_status_type,
                                                    TaskStatusData.time > time_for_status_query,
                                                    ancestor=shadow_key).order(-TaskStatusData.time).get()
